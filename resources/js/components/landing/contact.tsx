...
const Contact = () => {
    return (
        <div className="mx-auto flex flex-col items-center justify-center h-screen w-5/6 mt-60 sm:mt-32 md:mt-20 xl:mt-10">
            ...
            <div className="flex flex-wrap justify-evenly items-center w-full">
                ...
                <div className="lg:w-1/2 w-full">
                    ...
                    <div className="mt-4">
                        ...
                        <input type="email" id="email" className="border border-gray-300 rounded-md p-2 w-full" />
                    </div>
                    <div className="mt-4">
                        <label htmlFor="message">Message</label>
                        <textarea id="message" className="border border-gray-300 rounded-md p-2 w-full h-32"></textarea>
                    </div>
                    <button className="mt-6 bg-[#ff6abc] text-white px-4 py-2 rounded-md cursor-pointer hover:bg-pink-600 transition duration-300">
                        Send Message
                    </button>
                </div>
            </div>
